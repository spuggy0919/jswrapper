...
JS_METHOD(espclass_deepSleep)
{
    ...
    const jerryx_arg_t mapping[] ={
        jerryx_arg_uint32(&time_us, JERRYX_ARG_CEIL, JERRYX_ARG_NO_CLAMP, JERRYX_ARG_NO_COERCE, JERRYX_ARG_REQUIRED),
    };
    ...
    if(native_pointer) {
        EspClass* espclass = (EspClass*)native_pointer;
        espclass->deepSleep((uint32_t) time_us);
    }
    return jerry_undefined();
...
JS_METHOD(espclass_getSketchMD5)
{
    ...
    if(native_pointer) {
        EspClass* espclass = (EspClass*)native_pointer;
        return jerry_string(espclass->getSketchMD5());
    }
    return jerry_undefined();
...
JS_METHOD(espclass_partitionEraseRange)
{
    ...
    if(native_pointer) {
        EspClass* espclass = (EspClass*)native_pointer;
        return jerry_boolean(espclass->partitionEraseRange((uint8_t*) partition,(uint32_t) offset,(size_t) size));
    }
    return jerry_undefined();
...
JS_METHOD(espclass_partitionWrite)
{
    ...
    if(native_pointer) {
        EspClass* espclass = (EspClass*)native_pointer;
        return jerry_boolean(espclass->partitionWrite((uint8_t*) partition,(uint32_t) offset,(uint32_t*) data,(size_t) size));
    }
    return jerry_undefined();
...
JS_METHOD(espclass_partitionRead)
{
    ...
    if(native_pointer) {
        EspClass* espclass = (EspClass*)native_pointer;
        return jerry_boolean(espclass->partitionRead((uint8_t*) partition,(uint32_t) offset,(uint32_t*) data,(size_t) size));
    }
    return jerry_undefined();
...
JS_METHOD(espclass_getEfuseMac)
{
    ...
    if(native_pointer) {
        EspClass* espclass = (EspClass*)native_pointer;
        return jerry_number(espclass->getEfuseMac());
    }
    return jerry_undefined();
...
JS_METHOD(espclass_EspClass)
{
    ...
    JERRYX_UNUSED(args_p);
    JERRYXX_ON_ARGS_COUNT_THROW_ERROR_SYNTAX(args_cnt != 0, "Wrong arguments count");
    EspClass* espclass = new EspClass(); //4
    ...
    jerryx_property_entry props[] ={ //5 methods
        JERRYX_PROPERTY_STRING_SZ ("id", "EspClass"),
